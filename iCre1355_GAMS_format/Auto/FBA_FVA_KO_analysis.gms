**Include the simulation conditions for photoautotrophic growth
...
file result /All_single_gene_KO_auto.txt/;
...
loop(subj,
	...
	c(subj)=1;
	put subj.tl;
	v.fx('R_Biomass_Chlamy_auto')=wt_gr;
	solve FBA using lp maximizing Obj;
	put Obj.l:8:12;
