**Include the simulation conditions for heterotrophic growth
...
file result /All_single_gene_KO_hetero.txt/;
...
loop(subj,
	...
	c(subj)=1;
	put subj.tl;
	v.fx('R_Biomass_Chlamy_hetero')=wt_gr;
	solve FBA using lp maximizing Obj;
	put Obj.l:8:12;
